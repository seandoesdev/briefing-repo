...
## 11:54 — Bliki: Vibe Coding
**source**: martinfowler · **tags**: #the #to #it #of #that
...
Since the [November Inflection](/bliki/NovemberInflection.html) many programmers are
...
[Agentic Programming](/bliki/AgenticProgramming.html). Sadly the term “vibe coding” really
caught on, so many people use it to mean agentic programming. However I feel
that despite this rapid [Semantic Diffusion](/bliki/SemanticDiffusion.html), it's worth
...
change as the sophistication of models and their [harnesses](/articles/harness-engineering.html) change. These
...
aware of the [Lethal
Trifecta](/articles/agentic-ai-security.html#lethal-trifecta).
