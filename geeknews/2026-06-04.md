...
## 15:41 — 32GB DDR5가 이제 최소 $375 — AI발 공급 부족이 PC 조립을 계속 압박
**source**: geeknews · **tags**: #GB #가격 #PC #DDR #최저
**url**: https://news.hada.io/topic?id=30181
...
- AI 수요가 PC 하드웨어 공급망 전반의 제조 역량을 계속 소모하면서, 32GB DDR5 RAM 최저가는 $375 수준까지 상승함
- 정확한 최저가는 $374.97이며, PCPartPicker 기준으로 현재 구매 가능한 가장 싼 32GB DDR5 RAM 가격임
- 32GB DDR5는 2026년 게이밍 PC와 고성능 PC 구성에서 적정 용량으로 여겨지지만, 더 이상 $375 미만에서 찾기 어려운 상황임
- 가격 변동과 잡음이 커지면서 평균 가격보다 실제로 지불해야 하는 최저 수준의 가격이 더 중요한 기준이 됨

## 제품별 가격과 체감 부담

- 1년 전에는 $100 미만이 흔했던 RAM 키트가 이제 16GB 기준 $240 이상으로 올라감
- 32GB DDR5의 실거래 최저선은 한동안 $320 안팎이었고, 최근 몇 주 사이 $350을 넘어섬
- Silicon Power의 32GB(2x16GB) DDR5 6000MT/s CL36 키트 4종이 프로모션 코드 적용 시 $374.97로 최저가를 형성함
- 더 인기 있는 Corsair·Crucial 키트나 빌드 색상에 맞춘 RGB 제품은 $400을 쉽게 넘김
- 한때 $100 미만이던 부품이 이제 거의 4배가 되면서, 미관·타이밍·브랜드 선택을 고려하기 전부터 PC 조립 예산을 크게 압박함

## 용량 선택지와 업그레이드 제약

- 2026년에 PC를 새로 조립할 때 32GB는 사실상 목표로 삼아야 할 최소 적정 용량에 가까움
- 더 큰 용량을 원하면 64GB 가격이 $679.99까지 올라감
- 타협안인 16GB도 B&H Photo에서 $200 수준임
- [SK hynix 관련 보도](https://www.tomshardware.com/pc-components/dram/sk-group-chairman-says-memory-chip-shortage-will-last-until-2030)에서 제조 제약이 2030년까지 이어질 수 있어, 가격이 빨리 완화된 뒤 용량을 업그레이드하는 경로가 당장 보이지 않음

## 번들 딜과 가격 불확실성

- [RAM 콤보 딜](https://www.tomshardware.com/desktops/gaming-pcs/best-ram-combo-deals-2026-make-pc-builds-and-upgrades-more-affordable-with-the-best-ram-bundle-deals-available)은 RAM을 메인보드, 프로세서, 전체 PC 부품 세트와 묶어 $375 실거래선보다 낮게 살 수 있는 작은 완충 역할을 함
- 진행 중인 [Computex 2026](https://www.tomshardware.com/news/live/computex-2026-) 발표에서는 Nvidia RTX Spark 노트북과 PC, 신규 완제품 시스템, RAM 부품 등 여러 PC 하드웨어의 가격이 명확하지 않음
- 공급업체들은 출시 전 예상보다 높은 가격으로 잠재 구매자를 놀라게 하는 일을 피하려는 것으로 볼 수 있지만, 가격이 아직도 오르는 중이라 확정되지 않았을 가능성이 더 큼
- 저장장치도 크게 낫지 않아, [SSD 가격 추적](https://www.tomshardware.com/pc-components/ssds/ssd-price-tracking-2026-lowest-price-on-every-m-2-ssd) 기준 한때 $38까지 내려갔던 드라이브가 이제 $200에 거래됨

## 구형 플랫폼을 통한 대응

- AMD는 PC 게임 가격을 낮게 유지하려는 움직임으로 [Ryzen 7 5800X3D의 복귀와 Ryzen 7 7700X3D 출시](https://www.tomshardware.com/pc-components/cpus/amds-legacy-ryzen-7-5800x3d-chips-now-sell-for-up-to-usd800-more-than-a-new-9800x3d-am4-chip-costs-twice-as-much-as-msrp-as-enthusiasts-flock-to-old-ddr4-memory)를 발표함
- Intel은 메모리 가격을 두고 ["something has to give"](https://www.tomshardware.com/pc-components/cpus/intel-says-something-has-to-give-with-memory-prices-company-says-it-will-continue-to-make-sure-that-there-are-products-which-can-take-care-of-older-memory-technologies)라고 표현하며, Raptor Lake와 DDR4 같은 구형 메모리 기술을 활용할 수 있는 제품 선택지를 유지하려는 방향을 내비침
- DDR5 가격 급등은 최신 플랫폼으로의 이동 비용을 키우고, DDR4 같은 기존 메모리 생태계를 더 오래 활용하는 선택을 다시 부각시킴

---

## 20:44 — ESP32-S31
**source**: geeknews · **tags**: #ESP #기반 #Bluetooth #애플리케이션 #제공
**url**: https://news.hada.io/topic?id=30182
...
- ESP32-S31은 Espressif의 오픈소스 IoT 개발 프레임워크 [ESP-IDF](https://www.espressif.com/en/products/socs/en/products/sdks/esp-idf), Matter 기기용 [ESP-Matter](https://www.espressif.com/en/solutions/device-connectivity/esp-matter-solution#sdk-for-matter), ESP-BLE-AUDIO, 멀티미디어 애플리케이션용 [ESP-GMF](https://github.com/espressif/esp-gmf)를 통해 지원될 예정임
- [ESP Private Agents](https://developer.espressif.com/blog/2025/12/annoucing_esp_private_agents_platform/) 플랫폼 및 일반 LLM과 직접 연동해 AI 에이전트를 실행하거나 상호작용하는 클라이언트 기기를 만들 수 있는 방향임
- 제품 리소스에는 ESP32-S31 SoC, ESP32-S31-WROOM-3 모듈, ESP32-S31-Korvo-1 및 ESP32-S31-Function-Coreboard-1 개발 키트가 나열됨

---

## 22:45 — PlayStation 아키텍처
**source**: geeknews · **tags**: #GPU #CPU #CD #사용 #texture
**url**: https://news.hada.io/topic?id=30183
...
## 23:56 — VoidZero가 Cloudflare에 합류합니다
**source**: geeknews · **tags**: #Vite #Cloudflare #개발 #실행 #서버
**url**: https://news.hada.io/topic?id=30184

- **VoidZero**가 Cloudflare에 합류하며 팀 전원이 이동하지만, Vite, Vitest, Rolldown, Oxc, Vite+는 오픈소스·벤더 중립·커뮤니티 주도 프로젝트로 계속 유지됨
