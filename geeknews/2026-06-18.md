...
## 20:38 — 재미와 징역형을 부르는 IIS 서버 정찰
**source**: geeknews · **tags**: #IIS #파일 #경로 #config #web
**url**: https://news.hada.io/topic?id=30615
...
## 21:39 — 유출 재무 문서: OpenAI, 매년 수십억 달러 손실
**source**: geeknews · **tags**: #비용 #매출 #손실 #OpenAI #영업
**url**: https://news.hada.io/topic?id=30616
...
- OpenAI는 예상되는 **기업공개(IPO)** 를 앞두고 SEC에 비공개 S-1 서류를 제출함
- 유출된 감사 재무제표는 매출이 빠르게 늘어나는 동시에 더 큰 비용에 압도되는 재무 구조를 보여줌
- 매출은 2024년 **37억 달러**에서 2025년 **130.7억 달러**로 증가함
- Financial Times가 같은 문서를 검토한 결과, 2025년 말 월 매출은 거의 **20억 달러**까지 늘어남

## R&D와 운영 비용이 매출을 초과

- 최근 2년 동안 OpenAI의 총매출은 각각 **연구개발비**만으로도 초과됨
  - 2024년 R&D 비용: **78.1억 달러**
  - 2025년 R&D 비용: **191.8억 달러**
- 이 비용은 새 모델 훈련에 들어간 상당한 비용을 반영하는 것으로 보이며, 2025년 Microsoft에 지급한 R&D 비용만 **105.9억 달러**였음
- **매출원가**는 제품 생산과 배포에 들어간 비용으로, 2024년 26.5억 달러에서 2025년 75억 달러로 증가함
  - 늘어난 사용자 프롬프트에 모델이 응답하는 **추론 시점 컴퓨트 비용**을 반영하는 것으로 보임
- 판매·마케팅 비용도 2024년 **11.1억 달러**에서 2025년 **57.3억 달러**로 커짐

## 영업손실은 커졌지만 매출 대비 비율은 개선

- 일상 영업 기준 **영업손실**은 2024년 87.8억 달러에서 2025년 209.2억 달러로 증가함
- 회사가 투자자에게 **2030년 흑자화**를 기대한다고 말하는 상황에서, 손실 규모 증가는 부담 요인임
- 다만 매출 대비 영업손실 비율은 2024년 **237%** 에서 2025년 **160%** 로 낮아짐
- 절대 손실은 커졌지만, 매출 대비 손실 비율은 전년보다 줄어든 상태임

## 순손실에는 일회성 회계 비용이 포함

- headline 기준 **순손실**은 2024년 50억 달러 조금 넘는 수준에서 2025년 거의 390억 달러로 커짐
- 2025년 순손실에는 OpenAI가 2025년에 **영리 구조**로 전환하는 과정에서 투자자 가치평가와 관련된 큰 회계 비용이 포함됨
- Financial Times는 사안에 정통한 인물을 인용해 이 **비반복 비용**이 약 300억 달러였다고 전함
- 이 비용을 제외하면 2025년 순손실은 약 **80억 달러**였음

## 흑자 전환을 압박하는 요인

- 손실을 흑자로 돌리려면 비용을 줄여야 하며, 특히 모델 훈련과 연결된 거대하고 증가하는 **R&D 비용** 관리가 필요함
- 기업 고객은 **토큰 기반 가격**에 반발하기 시작했고, AI 지출에 대해 측정 가능한 투자수익률을 요구하고 있음
- 구독 영역에서는 경쟁사 Anthropic의 압력이 OpenAI의 가격 인하로 이어질 수 있으며, 이는 단기적으로 영업손실을 더 키울 수 있음
- OpenAI는 3월 **Sora** 비디오 생성 모델을 종료함
- 비슷한 시기 OpenAI 애플리케이션 CEO Fidji Simo는 직원들에게 회사가 “side quests”를 줄이고 핵심 코딩 및 비즈니스 사용자에 집중하겠다고 말함

## 자금 조달과 사용자 규모

- OpenAI는 3월 **1,220억 달러** 규모의 자금 조달을 했고, 이 라운드에서 회사 가치는 **8,520억 달러**로 평가됨
- ChatGPT의 주간 활성 사용자는 **9억 명 이상**임
- 이 중 유료 구독자는 약 **5,000만 명**임

---

## 22:40 — Stop Killing Games, 130만 서명에도 EU 법제화 확보 실패
**source**: geeknews · **tags**: #게임 #집행 #위원회 #종료 #퍼블리셔
**url**: https://news.hada.io/topic?id=30617
...
- **Stop Killing Games** 캠페인은 퍼블리셔가 공식 지원을 종료한 뒤에도, 완성품으로 판매한 게임을 플레이 불가능하게 만들어서는 안 된다는 취지로 추진됨
- EU에서는 이 운동이 유럽시민발안 “**Stop Destroying Videogames**”로 공식 제출됨
- 2026년 1월 기준 **1,294,188건의 검증된 지지 서명**을 확보해, 유럽 집행위원회가 정식 검토해야 하는 100만 기준을 넘김
- 이후 절차는 다음 순서로 이어짐
  - 2026년 2월: 집행위원회에 제출
  - 2026년 4월: 유럽의회 청문회
  - 2026년 5월: 본회의 토론
...
- 집행위원회는 2026년 6월 16일 공식 답변에서, 퍼블리셔가 상업적 판매를 중단한 뒤에도 게임을 계속 플레이 가능하게 유지하도록 하는 **법적 의무**를 제안할 수 없다고 밝힘
- 대신 2026년 말까지 비디오게임 업계와 소비자 대표가 참여하는 논의를 시작해, 게임의 수명 종료를 관리하기 위한 **업계 행동강령**을 만들 계획임
- 행동강령에는 다음 항목이 포함될 수 있음
  - 게임이 중단될 가능성에 대한 **스토어 표시 투명성** 강화
  - 퍼블리셔와 문화유산 기관 간의 게임 보존 협력 확대
- 다만 행동강령은 퍼블리셔에게 다음 조치를 법적으로 요구하지 않음
  - 오프라인 패치 제공
  - 사설 서버 도구 제공
  - 공식 지원 종료 후에도 플레이어가 게임에 접근할 수 있는 기타 수단 제공

## 집행위원회가 든 거부 사유

- 집행위원회는 캠페인이 요구한 법적 의무가 **비례적이지 않다**고 판단함
- 우려한 쟁점은 지식재산권, 기밀 비즈니스 정보, 퍼블리셔 비용, 게임 지원 종료 이후의 사이버보안 또는 안전 위험임
- 기존 EU 소비자법에도 일부 보호 장치가 있다고 봄
  - 투명성 요건
  - 계약 기간
  - 종료 조건
  - 종료가 계약 또는 소비자의 합리적 기대와 충돌할 경우 가능한 환불

## Ubisoft의 The Crew 사례와 현재 영향

- Reuters에 따르면, 이번 결정은 프랑스 소비자단체 **UFC-Que Choisir**가 Ubisoft를 상대로 The Crew 관련 법적 절차를 계속 진행하는 가운데 나옴
- The Crew는 서버 종료 뒤 영구적으로 플레이할 수 없게 됨
- Ubisoft는 플레이어가 완전한 소유권이 아니라 **제한적 접근권**을 구매했다고 주장함
- 소비자단체는 플레이어들이 게임을 얼마나 오래 이용할 수 있는지에 대해 오도됐다고 주장함
- 이번 답변으로 퍼블리셔는 현재 EU 전역에서 구매된 게임을 지원 종료 후에도 계속 플레이 가능하게 유지해야 하는 새로운 법적 의무를 지지 않음

## 캠페인의 다음 방향

- Stop Killing Games는 집행위원회 결정 이후에도 입법 추진을 끝내지 않겠다고 밝힘
- 공식 계정은 이번 결과가 **예상 밖이 아니었고**, 이미 대비하고 있었다고 밝힘
- 캠페인은 이제 유럽의회 의원들이 Stop Killing Games 내용을 **Digital Fairness Act**에 반영하도록 추진하고 있음
- 캠페인 측은 “집행위원회와 그들의 비결정 없이도 계속 갈 수 있다”고 밝혔고, 이는 Accursed Farms 제작자 Ross Scott의 이전 발언을 언급한 것임
- 6월 13일에도 Stop Killing Games 계정은 집행위원회 결정이 “끝이 아닐 것”이라며 California와 유럽의회에서의 진전을 언급함
- 원래 유럽시민발안에는 큰 타격이지만, 더 넓은 캠페인은 직접적인 집행위원회 조치보다 향후 EU 디지털 소비자 입법에 영향을 주는 쪽으로 이동하고 있음

---

## 23:50 — AI가 이미 자기계발 실용서를 죽였는가?
**source**: geeknews · **tags**: #감소 #The #Hour #판매 #추세
**url**: https://news.hada.io/topic?id=30611

- LLM 확산 이후 **실용서·자기계발서 판매**가 급격히 붕괴 중이며, 단순 추세가 아니라 지금 일어나는 **고속·고강도 파괴**로 진단
...
- **정보(information) 시장은 챗봇으로 수렴**하지만, 변화(transformation)를 만드는 장문 콘텐츠와 진짜 사람의 이야기는 여전히 가치를 가지며 **1,000명의 진정한 팬**에 집중하는 방향 제시

---

## 파괴의 속도와 강도

- 약 1주일 전 받은 스프레드시트가 충격의 계기였으며, 다수가 AI 변화를 막연히 느끼지만 **실제 파괴의 속도와 강도**를 직접 체감한 사람은 적음
...
- ### 하위 분류 추세
  ...
  - **자기계발(Self-help)** 부문이 전년 대비 **26.3% 감소**로 가장 가파른 낙폭 기록
  - 16개 하위 분류 중 성장한 곳은 단 2개로, **공예/취미/골동품/게임(9.6%)** 과 **종교(1.6%)** 만 상승
...
- 5종 모두 **NYT/WSJ #1 베스트셀러**였고, *The 4-Hour Workweek*은 출간 10년 후인 2017년에도 Amazon 최다 하이라이트 도서 중 하나로, 오랜 기간 안정적 수익원 역할
- ### 연도별 인쇄 판매 감소율
...
- ### 전 포맷 및 동종 업계
  ...
  - Amazon 재고 변화, 팬데믹 후 소비 변화, *The 4-Hour Body*의 2024년 TikTok 바이럴(Gary Brecka) 같은 이상치 회귀 등 반론 가능 요소 존재하나, **처방형(prescriptive) 비소설의 수직 낙하**를 설명하기엔 불충분
  - 세계 최상위 자기계발 프랜차이즈들도 동일하게 타격, 상반기 판매 집중 가정 시 주요 브랜드 **약 40~60% 감소** 추정
  - 저자의 에이전트는 2025년 첫 큰 하락, 2026년 더 심각, 그 사이 변한 유일한 요소는 **AI 가속**이라고 단언
  - YouTube·팟캐스트 성장은 상대적으로 미미한 요인으로 평가

## 실제로 무슨 일이 벌어지는가

- 저자 저서는 기능적으로 **'조회표(lookup table)'** 또는 *Choose Your Own Adventure* 방식의 메뉴(체지방 감량, 수면 개선, 근육 증가 등)이며, *The 4-Hour Workweek*은 라이프스타일·수입 자동화를 위한 **의사결정 트리**
- 2019년에는 그 답에 접근하는 최선의 인터페이스가 책이었으나, 2026년에는 수백만 명이 **무료 챗봇**을 최선의 인터페이스로 인식
- 챗봇은 저자 책과 수천 권을 학습해 체중·일정·부상·취향까지 반영한 **개인화 프로토콜을 15초 만에** 제공
- 반론도 제시 가능하나 추세는 가속·심화되며, **조언 산업 거의 전체**가 영향권에 놓임
...
- ### 대체 위험 포맷
  ...
  - **처방형 팟캐스트**: 800개 이상 에피소드의 핵심을 AI가 추출·요약·개인화하면 재생 동기 감소, 원하는 포맷(텍스트·오디오·영상)으로 제공, *Ready Player One*에 가까운 기술이 예상보다 임박
  - **온라인 강좌, 뉴스레터, 조언 블로그**: "내 머릿속 지시를 전달"하는 핵심 가치가 무료·대화형 인터페이스와 경쟁
- ### 더 큰 함의

  - LLM이 검색·구매뿐 아니라 영상 탐색·팟캐스트 요약·강좌 탐색·도서 열람까지 **모든 것의 인터페이스**가 되며, 원본 콘텐츠는 사라지지 않되 대부분이 직접 접하지 않는 **원재료**로 전락
...
- ### 살아남을 영역
  ...
  - 스탠드업 특집 요약이나 위대한 소설의 줄거리 요약은 원본을 대체 못함, **목소리·취향·개성**이 유일하게 견고한 해자가 될 가능성

## 왜 패닉에 빠지지 않는가

- 글쓰기를 시작한 이유는 단위 경제성이 아니라, 책이 **2~3년의 삶을 압축한 최고 밀도의 몰입 전이**이기 때문이며, 본인에게 가장 큰 영향을 준 책들도 대형 베스트셀러는 아니었음
- ### 핵심 반론 — 시퀀싱과 이야기

  - 저자 책의 비결은 **논리적 순서 배열(sequencing)** 과 *The 4-Hour Body*의 The Harajuku Moment 같은 **깊은 개인적 이야기**로, 오랜 습관 변화를 촉발
  - *The 4-Hour Body*는 2010년 출간, 608페이지로 NYT #1 기록
  - 똑똑한 지인들이 "책 읽을 시간 없으니 살 빼는 핵심 불릿만 보내달라" 요청 → 불릿을 받은 사람 중 실천자는 **정확히 0명**
  - 반면 세심하게 설계된 경로를 따라간 **수천 명의 독자**는 다른 다이어트 실패 후에도 45kg 이상 감량 성공
- ### 저자가 도달한 결론

  - **"1,000만 명용 숏폼 영상보다 1만 명용 책을 쓰겠다"**, 더 나아가 며칠·몇 분 만에 잊는 1,000만 명보다 **진정으로 변화하는 1만 명**을 위한 책 선호
  - 팟캐스트 클립이 5천만~1억 뷰, 5만 좋아요를 기록해도 전체 에피소드 다운로드 전환은 **정확히 0**, 알고리듬 추격은 바닥을 향한 경쟁
  - **정보 시장은 챗봇으로 붕괴**하지만 변화(transformation) 시장은 더 작고 기이하며 흥미로워질 가능성, 인터넷 초기로의 회귀
  - 처방형 비소설의 대중 정보 사업으로서의 죽음은 임박, 일시적 예외는 있으나 추세선은 한 방향

## 기본으로의 회귀

- 모든 작가·팟캐스터·창작자의 질문은 인터페이스 전환이 *올지*가 아니라 *왔을 때 무엇을 할지*이며, **마르기 전에 우물을 파둘 것** 강조
- ### 3단계 회귀 전략
