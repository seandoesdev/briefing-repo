...
## 23:37 — SpaceX, 90조원에 Cursor 인수
**source**: geeknews · **tags**: #SpaceX #AI #Cursor #인수 #기업
**url**: https://news.hada.io/topic?id=30551
...
- Elon Musk의 SpaceX가 인기 AI 코딩 에이전트 **Cursor**를 만든 스타트업 Anysphere를 **600억 달러 전액 주식 교환** 방식으로 인수
- 이번 거래는 지난주 SpaceX의 Nasdaq 상장 직후 성사, 당시 기업 가치는 **2조 달러 이상**으로 급등
- 2025년 2월 SpaceX에 인수된 xAI가 이번 거래로 **AI 코딩 분야 입지 강화**
  - AI 코딩은 기업들이 AI를 실제 비즈니스 매출원으로 전환한 초기 영역 중 하나
- SpaceX는 IPO 투자자에게 이론상 최대 매출인 **28.5조 달러 규모의 시장**을 제시했으며, 이 중 상당 부분이 기업용 AI에서 나올 것으로 전망
  - 해당 시장 공략이 SpaceX에 핵심적이라는 점이 인수 배경

## Cursor의 위치와 한계

- Cursor는 AI로 코딩을 자동화해 다수 개발자를 확보한 실리콘밸리 스타트업으로, 시장 선두 **Anthropic·OpenAI의 핵심 경쟁사**
- 다만 **컴퓨팅 파워 접근 부족**으로 성장이 제약되어 온 상태
- Hargreaves Lansdown 선임 애널리스트 Matt Britzman: "Cursor는 OpenAI나 Anthropic만큼의 규모는 없으나, **비용 대비 인상적인 코딩 모델**을 구축했고, 이번 거래는 SpaceX에 긍정적"

## 거래 조건 및 기술 통합

- SpaceX는 수개월간 Cursor를 검토해 왔으며, 4월에 **600억 달러 인수** 또는 **100억 달러 파트너십** 중 선택 옵션 공개
- IPO 서류에서 Cursor가 보유한 **개발자 데이터**(코딩 요청, 설계 결정 포함)가 Grok 같은 AI 모델 개선에 기여 가능하다고 명시
- SpaceX는 곧 Cursor에 AI 모델 출시 예정, 더불어 수개월간 공동 훈련해 온 xAI 코딩 에이전트 **Grok Build**도 함께 제공
- 거래는 IPO 수익을 사용하지 않는 전액 주식 방식으로 **2026년 3분기 마감 예정**

## 주가 및 시가총액 영향

- 발표 후 초기 거래에서 주가 10% 상승, 시가총액 2.53조 달러에 약 **2,470억 달러 추가** 전망
- 주가는 211.27달러로, IPO 가격 135달러 대비 **56% 이상 상승**
- 상승세 유지 시 SpaceX는 Amazon을 제치고 **시가총액 5위 기업** 등극 가능

## 고위급 투자자와 빠른 성장

- 주식 지급 방식은 SpaceX의 높은 기업 가치를 활용, 600억 달러 거래에서 상대적으로 **적은 지분 희석**으로 가능
  - 억만장자 Bill Ackman(X 게시글): SpaceX의 높은 가치 덕분에 **Cursor 인수의 희석 비용이 훨씬 낮음**
- Cursor는 2022년 설립 이후 빠르게 성장, 연환산 B2B 매출 약 **26억 달러**, 기업 판매 급증
- San Francisco 소재 기업으로 Andreessen Horowitz, Thrive, Nvidia, Alphabet의 Google 등이 투자
  - 기업 가치 **500억 달러** 규모의 펀딩 라운드 논의 보도

## 계약 해지 조항 및 데이터센터 영향

- 특정 상황에서 거래 무산 시 SpaceX는 **100억 달러 위약금** 지급, 반독점 문제로 무산될 경우에는 **40억 달러**만 지급
- 이번 거래가 SpaceX의 데이터센터 임대 계약에 미칠 영향은 즉시 불분명
- SpaceX는 최근 Anthropic·Google과 연 **약 260억 달러** 규모 클라우드 컴퓨팅 용량 임대 계약 체결
  - 두 계약 모두 **90일 해지 조항** 포함, 필요 시 SpaceX가 컴퓨팅 용량 신속 회수 가능
- D.A. Davidson 애널리스트 Gil Luria: Grok과 Cursor 사용량이 충분히 증가하면 내부 사용으로 전환 가능하나, 당분간은 Anthropic·Google에 용량 제공 전망

---

## 23:47 — 구리 운반 약물이 기억을 회복하고 독성 알츠하이머 단백질을 제거하다
**source**: geeknews · **tags**: #알츠하이머 #단백질 #Cu #ATSM #아밀로이드
**url**: https://news.hada.io/topic?id=30552
...
- 혈액-뇌 장벽 복구 외에도 구리 치료가 뇌의 면역세포인 **미세아교세포**가 독성 플라크를 섭취하고 분해하도록 도울 가능성이 있음
...
## 23:47 — Fox, 스트리밍 확장 위해 33조원에 Roku 인수 계약 체결
**source**: geeknews · **tags**: #Fox #Roku #거래 #콘텐츠 #TV
**url**: https://news.hada.io/topic?id=30546

- 방송 사업자 **Fox Corp**가 스트리밍 플랫폼 **Roku**를 약 **220억 달러($22b)** 규모의 현금·주식 혼합 거래로 인수, 광고 사업 강화와 스포츠·뉴스 콘텐츠의 온라인 도달 확대를 노림
- Roku 플랫폼을 사용하는 **1억 가구 이상**에 대한 접근권 확보로, 케이블 TV 의존도가 높은 Fox가 디지털 시청자 확대·정밀 광고 타게팅·전통 유통 의존도 축소 가능
- Roku 주주는 보유 주식당 **현금 96달러와 Fox Class A 주식 약 0.97주** 수령, 주당 160달러로 평가되며 목요일 종가 대비 **33.7% 프리미엄**
- 거래 완료 후 **Fox 주주가 합병 회사 지분 약 73%** 보유, 2027년 상반기 마감 예상
- 콘텐츠·플랫폼 결합에 대한 회의론과 기존 파트너십 충돌 우려 속, **미국 TV 시청 점유율 3위** 사업자로 재편될 전망
