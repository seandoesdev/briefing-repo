...
## 00:13 — Prompt Injection as Role Confusion
**source**: simonwillison · **tags**: #the #of #to #text #role
...
## 00:13 — Porting the Moebius 0.2B image inpainting model to run in the browser with Claude Code
...
## 01:04 — Porting the Moebius 0.2B image inpainting model to run in the browser with Claude Code
**source**: simonwillison · **tags**: #the #to #and #it #in
**url**: https://simonwillison.net/2026/Jun/22/porting-moebius/#atom-everything
...
## 19:11 — OPFS + Pyodide test harness
**source**: simonwillison · **tags**: #the #Pyodide #Datasette #in #to
