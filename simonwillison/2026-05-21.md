...
## 20:30 — datasette-agent 0.1a1
**source**: simonwillison · **tags**: #datasette #agent #the #to #Release
**url**: https://simonwillison.net/2026/May/14/datasette-agent/#atom-everything

**Release:** [datasette-agent 0.1a1](https://github.com/datasette/datasette-agent/releases/tag/0.1a1)
